						...
						<div id="main_area">
						            ...
						            <div class="carousel slide" id="contentCarousel">
						              ...
						              <div class="carousel-inner">
						                <div class="active item" data-slide-number="0">
						                  <img src="assets/img/Poltronaegg/1.jpg" class="img-responsive center-block" alt="">
						              	</div>
						    ...
						    <div class="row hidden-xs" id="slider-thumbs">
						      ...
						      <ul class="hide-bullets">
						        <li class="col-sm-2">
						          <a class="thumbnail" id="carousel-selector-0"><img src="assets/img/Poltronaegg/1.jpg" class="img-responsive center-block" alt=""></a>
						        </li>        
						      </ul>
						    </div>
						  </div>
